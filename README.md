...
By looking at graphs, one can see that a majority of the student prefer going to parties that are off campus. However, on campus parties does overtake off campus in certain areas, especially in fraternity or sorority. This might be the cause of restrictions applied to students that are on campus or in certain organizations. Students off campus have more freedom, which would be more appealing.  
...
The above maps shows the total number of AP Computer Science A exam takers in each state. The data was obtained from [Kaggle](https://www.kaggle.com/iceatgt/ap-computer-science-a-exam-dataset?select=pass_12_13.csv)
